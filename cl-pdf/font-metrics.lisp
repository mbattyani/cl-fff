...
(defgeneric font-type (t))
(defgeneric font-descriptor (t &key embed errorp))
(defgeneric make-dictionary (t &key &allow-other-keys))
...
(defmethod make-dictionary ((fm font-metrics)
                            ...
                            &allow-other-keys)
  (declare (special *embed-fonts*)) ;; defined later, in font.lisp
