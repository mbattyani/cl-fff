...
(defun parse-date (string)
  (let* ((pos1 (position #\/ string))
    ...
    (when (and pos1 pos2)
      (let ((n1 (parse-integer string :start 0 :end pos1))
	    (n2 (parse-integer string :start (1+ pos1) :end pos2))
	    (n3 (parse-integer string :start (1+ pos2))))
	(unless (and n1 n2 n3) (error "bad date : ~s" string))
	(when (< n3 100) (incf n3 2000))
	(encode-universal-time 0 0 0 n1 n2 n3)))))
