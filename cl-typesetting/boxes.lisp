...
(defgeneric stroke (t real-1 real-2))
(defgeneric do-layout (t))
(defgeneric cut-point (t))
(defgeneric convert-hyphen-to-char-box (box))
(defgeneric execute-box (executable-box))
(defgeneric compute-natural-box-size (box))
(defgeneric align-baseline (box symbol))
(defgeneric map-boxes (box real-1 real-2 function))
(defgeneric dx (box))
(defgeneric (setf dx) (t box))
(defgeneric dy (box))
(defgeneric (setf dy) (t box))
(defgeneric baseline (box))
(defgeneric (setf baseline) (t box))
(defgeneric offset (box))
(defgeneric (setf offset) (t box))
(defgeneric delta-size (obj))
(defgeneric max-expansion (obj))
(defgeneric expansibility (obj))
(defgeneric max-compression (obj))
(defgeneric compressibility (obj))
(defgeneric locked (box))
(defgeneric (setf locked) (t box))
(defgeneric soft-box-p (box))
(defgeneric char-box-p (box))
(defgeneric white-char-box-p (box))
(defgeneric trimmable-p (box))
(defgeneric white-space-p (box))
(defgeneric hmode-p (box))
(defgeneric vmode-p (box))
(defgeneric adjust-box-dx (box dx baseline))
