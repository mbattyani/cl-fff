...
(defgeneric style-p (t))
(defgeneric use-style (style))
(defgeneric save-style (style))
(defgeneric restore-style (style))
(defgeneric make-restore-style (style))
(defgeneric copy-restore-style (style))
(defgeneric (setf font) (font text-style))
