   ...
   (html:html
    ...
    (:html
     (:head
      ...
      ((:link :rel "stylesheet" :href "/static/css/fcweb.css" :media "screen,projection" :type "text/css"))
      ((:link :rel "stylesheet" :href "/static/css/modal.css" :media "screen,projection" :type "text/css"))
