...
;;;  FIXES.
;;; (v. 1.2)
;;;  4/12/99  - Modified to work with LispWorks for Windows (Marc Battyani)
...
(defpackage :iterate
 ...
 (:export :iterate :iter :display-iterate-clauses :declare-variables
          ...
          :after-each :finally :if-first-time :finally-protected :finish
...
(defun free-vars (form bound-vars)
  ...
  (cond
   ...
   ((symbolp (car form))
    (cond
;Marc Added harlequin-pc-lisp
     ((or (#-(or ansi-90 allegro harlequin-pc-lisp) special-form-p
	     #+(or ansi-90 allegro harlequin-pc-lisp) special-operator-p (car form)) 
...
;Marc (defclause-driver (FOR var IN-PACKAGE pkg &optional EXTERNAL-ONLY (ext nil))
(defclause-driver (FOR var IN-PACKAGE pkg &optional EXTERNAL-ONLY ext)
